...
static asn_TYPE_member_t asn_MBR_BasicSafetyMessage_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct BasicSafetyMessage, safetyExt),
	...
	{ ATF_POINTER, 3, offsetof(struct BasicSafetyMessage, status),
	...
	{ ATF_POINTER, 2, offsetof(struct BasicSafetyMessage, vehicleDataV2VI),
	...
	{ ATF_POINTER, 1, offsetof(struct BasicSafetyMessage, testDataFrameV2VI),
...
static asn_TYPE_tag2member_t asn_MAP_BasicSafetyMessage_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* msgID at 55 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* blob1 at 58 */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 }, /* safetyExt at 87 */
    { (ASN_TAG_CLASS_CONTEXT | (3 << 2)), 3, 0, 0 }, /* status at 88 */
    { (ASN_TAG_CLASS_CONTEXT | (128 << 2)), 4, 0, 0 }, /* vehicleDataV2VI at 90 */
    { (ASN_TAG_CLASS_CONTEXT | (129 << 2)), 5, 0, 0 } /* testDataFrameV2VI at 91 */
};
