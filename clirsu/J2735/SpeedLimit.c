...
static asn_TYPE_member_t asn_MBR_item_3[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct SpeedLimit_item, choice.itis),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct SpeedLimit_item, choice.text),
...
static asn_TYPE_tag2member_t asn_MAP_item_tag2el_3[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* itis at 1948 */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* text at 1949 */
};
static asn_CHOICE_specifics_t asn_SPC_item_specs_3 = {
	sizeof(struct SpeedLimit_item),
	offsetof(struct SpeedLimit_item, _asn_ctx),
	offsetof(struct SpeedLimit_item, present),
	sizeof(((struct SpeedLimit_item *)0)->present),
...
static asn_TYPE_tag2member_t asn_MAP_Member_tag2el_2[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* item at 1948 */
};
